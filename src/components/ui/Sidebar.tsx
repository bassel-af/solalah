  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isMobileOpen ? 'is-open' : ''}`}>
        ...
        <div className="sidebar-search-hero">
          <div className="sidebar-search-content">
            ...
            <input
              type="text"
              className="sidebar-search-primary"
            ...
            {searchFilter && (
              <button
                className="sidebar-search-clear-primary"
          ...
          <span className="sidebar-search-results">
        ...
        <div className="sidebar-stats-compact">
          <div className="stat-chip">
            <span className="stat-chip-value">{indCount}</span>
            <span className="stat-chip-label">فرد</span>
          </div>
          <div className="stat-chip">
            <span className="stat-chip-value">{famCount}</span>
            <span className="stat-chip-label">عائلة</span>
          </div>
        </div>
        ...
        <div className="sidebar-settings">
          <button
            className={`sidebar-settings-toggle ${isSettingsOpen ? 'is-open' : ''}`}
          ...
          >
            ...
            <span className="settings-label">خيارات متقدمة</span>
            <svg className="settings-chevron" width="14" height="14" viewBox="0 0 24 24" fill="none">
          ...
          {isSettingsOpen && (
            <div className="sidebar-settings-content">
              <div className="sidebar-settings-field">
                <label className="sidebar-settings-label">الجد الأعلى</label>
                <p className="sidebar-settings-hint">اختر الجد الأعلى لتصفية الشجرة</p>
