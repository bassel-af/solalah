...
- Supabase Auth self-hosted (Docker Compose): email/password + Google SSO
- Phone OTP infrastructure ready in Supabase but activation deferred (SMS gateway not configured yet)
